...
import bannerImg_1 from '@/assets/img/banner/banner_img03.png'
import bannerImg_2 from '@/assets/img/banner/banner_round_bg_blue.png'
            ...
            <div className="row justify-content-center">
               <div className="col-xxl-8 col-xl-7 col-lg-8 col-md-10">
                  <div className="banner-content text-center">
                     <p className="banner-caption">Descubre el Poder de Nuestros Ácidos Hialurónicos y Toxinas Botulínicas</p>
                     <h2 className="title">Productos de Belleza y Rejuvenecimiento</h2>
                     {/* <Link href="/shop" className="eg-btn btn-two"></Link> */}
                  </div>
               </div>
            </div>
            <div className="row">
